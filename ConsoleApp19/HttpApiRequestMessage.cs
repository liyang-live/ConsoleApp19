...
namespace WebApiClient
{
    ...
    public class HttpApiRequestMessage : HttpRequestMessage
    {
        ...
        /// <exception cref="NotSupportedException"></exception>
        /// <returns></returns>
        public  Task AddFormFieldAsync(IEnumerable<KeyValuePair<string, string>> keyValues)
        {
            ...
            if (formContent == null)
            {
             ...
             formContent.AddFormFieldAsync(keyValues);
        ...
        public  string ToStringAsync()
        {
            ...
            if (this.Content != null)
            {
                var content =  this.Content.ReadAsStringAsync();
